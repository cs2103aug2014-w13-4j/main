...
public class LogicTest {
	...
	Method modifyTask = TaskModifierClass.getDeclaredMethod("modifyTask",
			Command.class, Task.class);
	Method display = LogicClass.getDeclaredMethod("display", Command.class);
	...
	public final void testDisplayIndividualTask() throws Exception {
		...
		Feedback feedback = (Feedback) display.invoke(logic, displayCommand);
