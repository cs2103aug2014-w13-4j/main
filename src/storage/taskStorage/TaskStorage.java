...
public class TaskStorage {
    ...
    private String taskPropertyToString(Integer intProperty) {
        if (intProperty == null) {
            return "";
        } else {
    ...
    private String taskPropertyToString(String strProperty) {
        return strProperty;
    }

    // convert calendar task property to string
    private String taskPropertyToString(Calendar calendarProperty) {
    ...
    private String taskPropertyToString(Boolean booleanProperty) {
    ...
    private String taskPropertyToString(ArrayList<String> stringArrayListProperty) {
    ...
    private String taskIntPropertyToString(ArrayList<Integer> intArrayListProperty) {
    ...
    private String arrayListToString(ArrayList<String> stringArray) {
    ...
    private Calendar stringtoTaskProperty(String propertyString) throws ParseException {
