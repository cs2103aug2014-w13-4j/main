...
public class Logic {
	...
	private static final String DISPLAY_TASK_MESSAGE = "Task %1$s are displayed.";
	...
	private Feedback displayTask(int id) throws TaskNotFoundException {
		...
		return createTaskFeedback(createMessage(DISPLAY_TASK_MESSAGE, String.valueOf(id), null),
				task);
	}
